...
TODO: Clarify the asymmetry: plain form for *input* starts Day 1 via Comprehensible Japanese (Yuki) videos, which use natural mixed register. The learner's ear is exposed to plain form continuously even while output remains polite.

## Concrete Rule

TODO: Write out the operational rule clearly: "If in doubt which register to produce, use polite before Module 06. From Module 06 onward, match the register of your interlocutor or default to plain with close-aged peers."

## Register-Switching Exercises (Module 06+)

TODO: Preview the exercises from Module 06: convert 10 polite sentences to plain and 10 plain dialogues from Comprehensible Japanese to polite. Note these are in `modules/06-past-and-plain-forms/`.
