...
## Operating Principle 1: Comprehensible Input from Day 1 (Krashen i+1)

TODO: Explain the Krashen i+1 hypothesis as applied to this curriculum. The brain acquires language most efficiently when input is slightly above current level. Concretely: listening to Comprehensible Japanese (Yuki) and Nihongo con Teppei Beginners starts in Module 00, not after finishing a textbook unit. Provide rationale and cite the listening resources gated by module in `listening/resources-by-level.md`.
...
TODO: Explain that grammar is acquired through reading, listening, and targeted drills — not through flashcards. Anki's role is restricted to vocab and kanji recognition. Cross-reference `pedagogy/03-srs-strategy.md` for Anki configuration details. Note the risk of "SRS-acquired grammar" that never becomes automatic in production.
