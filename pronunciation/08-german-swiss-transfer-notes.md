...
TODO: Note what Standard German contributes:
- **[ts] cluster**: German "z" = [ts] (e.g. *Zeit*, *zwei*) — same as Hungarian; reinforces the つ production.
- **Vowel length distinction**: German also has phonemic vowel length, reinforcing the Japanese long-vowel habit.
...
TODO: Write out 3–5 drills that leverage the Swiss German advantages: ひ words, り words, and geminate words. Confirm correct use of alveolar variant for り by recording and comparing.
