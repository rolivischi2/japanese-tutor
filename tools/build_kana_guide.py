...
<link href="https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,400;0,9..144,600;0,9..144,700;1,9..144,400&family=Shippori+Mincho:wght@500;600;700;800&display=swap" rel="stylesheet">
<style>
:root{
...
.sec-head .sec-jp{font-family:"Shippori Mincho",serif;color:var(--vermilion);
...
.cell .k{font-family:"Shippori Mincho",serif;font-size:30px;font-weight:700;
...
.d-hero .big{font-family:"Shippori Mincho",serif;font-size:108px;
...
.look .lk{font-family:"Shippori Mincho",serif;font-size:26px;
...
.prompt .big-q{font-family:"Shippori Mincho",serif;font-size:88px;
  font-weight:800;line-height:1;color:var(--ink)}
...
.opt{background:var(--cell);border:1.5px solid var(--cell-line);
  ...
  transition:all .13s ease;font-family:"Shippori Mincho",serif;
  font-size:34px;font-weight:700;color:var(--ink)}
.opt.romaji{font-family:"Fraunces",serif;font-style:italic;font-size:24px}
...
function speak(text){
  ...
  u.lang='ja-JP'; u.rate=.78; u.pitch=1;
